...
rem ---------------------------------------------------------------------------
rem  Removes every plausible ISO install, in BOTH shapes (folder bundle and
...
set "P1=%CommonProgramFiles%\VST3\ISO.vst3"
set "P2=%CommonProgramFiles(x86)%\VST3\ISO.vst3"
set "P3=%ProgramFiles%\Common Files\VST3\ISO.vst3"
set "P4=%LOCALAPPDATA%\Programs\Common\VST3\ISO.vst3"
set "P5=%ProgramFiles%\Naaman\ISO"
